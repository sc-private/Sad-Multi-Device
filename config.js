...
global.owner = [
  ...
  ['+62 813-4915-2362'],
  ['+62 813-4915-2362'],
  ['+62 813-4915-2362', 'IRGI STORE', true],
  ['+62 813-4915-2362', 'IRGI STORE', true],
  ['6281349152362', 'Bot', true],
  ['+62 813-4915-2362', 'IRGI STORE', true],
  ['+62 813-4915-2362', 'IRGI STORE', true],
...
global.wm = '                「 IRGI BOT 」' //Main Watermark

global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘օառɛʀ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'

global.wm3 = '⫹⫺ IRGI BOT'

global.botdate = `⫹⫺ 𝑫𝒂𝒕𝒆 :  ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}`

global.bottime = `𝑻𝑰𝑴𝑬 : ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}`

global.titlebot = `⫹⫺ 𝑻𝑰𝑴𝑬 𝑺𝑬𝑹𝑽𝑬𝑹 : ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}\n⫹⫺ Date Server :  ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}
`

global.author = '                「 IRGI 𝑩𝒐𝒕⁩ 」'
...
/*============== NOMOR ==============*/
global.nomorbot = '628219716-0513'
global.nomorown = '6281349152362'
